...
The full kaioken SDK bound to this server over loopback — threads, projects,
...
methods, not their arguments — read the bundled `kaioken-plugin-sdk.d.ts` for exact
...
| `guide`          | `render` (the `kaioken guide` text; local, no request)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
