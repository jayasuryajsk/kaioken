...
description: "Create or change Kaioken plugins and Plugin SDK extensions, including CLI commands, agent tools, providers, and UI surfaces."
---

# Author Kaioken plugins

A Kaioken plugin is a TypeScript package that can add server behavior, agent
...
routes to detailed references, but the installed Kaioken version decides the exact
API.
...
Use kaioken plugin new <name> for a new plugin. The scaffold includes frontend files.
...
- Run kaioken plugin types when SDK declaration versions can drift.
- Run kaioken plugin build before install, release, or marketplace submission.
