---
name: skill-creator
description: "Create or improve Kaioken skills, including their triggers, instructions, and supporting resources."
---

# Skill creator

Create skills that add useful domain knowledge and trigger only for relevant tasks.
User skills live at `~/.kaioken/skills/<name>/SKILL.md`. Edit built-in and plugin
...
Kaioken loads names and descriptions for discovery, the body when a skill is used,
