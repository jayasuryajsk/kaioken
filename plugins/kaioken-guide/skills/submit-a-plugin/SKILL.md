...
description: "Prepare and submit a Kaioken plugin to the Community marketplace when publication or a marketplace PR is requested."
---
...
The marketplace contract can change independently from Kaioken releases. Read these
...
2. Validate the plugin with its package manager and kaioken plugin build.
...
Use scripts/derive-plugin-id.mjs to calculate the same plugin ID that Kaioken uses:
