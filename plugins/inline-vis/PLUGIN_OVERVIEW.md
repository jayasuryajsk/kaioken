...
HTML runs in a sandboxed iframe with an opaque origin. Scripts in the file cannot read the kaioken page, its cookies, or its storage. Markdown uses kaioken's renderer with raw HTML disabled.
