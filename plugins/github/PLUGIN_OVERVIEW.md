See the open issues and pull requests of your repositories inside kaioken. Hand one to an agent with one click.
...
- Send agent on an issue, or Review with agent on a pull request. kaioken starts a thread in the repository's project and links it from the item.
