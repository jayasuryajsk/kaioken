...
const SHARED_FIXTURE_ANCHORS: readonly FixtureAnchor[] = [
  ...
  },
  {
    ...
    because: "Mock thread and settings rows keep Kaioken's shared row geometry and rest, hover, selected, and split states.",
  },
  {
    file: "apps/app/src/components/sidebar/SectionSidebar.tsx",
    mustContain: [
      'from "@kaioken/shared-ui/button"',
      "PROJECT_LIST_ACTION_BUTTON_CLASS",
      "CHROME_SECTION_LABEL_CLASS",
      "SIDEBAR_STANDARD_ROW_PADDING_CLASS",
    ],
    because: "Mock sidebars use Kaioken's shared button primitive, section-label token, padding, and project-row anatomy.",
  },
  {
  ...
  },
  {
    ...
    mustContain: [
      ...
      "--spacing:", "--tracking-normal:", "--kaioken-sidebar-row-height:", "--icon-stroke-width:", "--radius:",
      ...
      "--kaioken-sidebar-open-in-split-background",
    ],
...
export const VIEW_FIXTURE_ANCHORS = {
  thread: [
    ...
    },
    {
      ...
      because: "The thread projection exposes the same fixed secondary-panel tabs as Kaioken.",
    },
    {
      ...
      because: "The open Info panel projects Kaioken's flat metadata card and representative environment, branch, and pull-request rows.",
    },
    {
  ...
  new: [
    {
      ...
      because: "The New thread projection uses Kaioken's current empty-welcome actions, hierarchy, and hover state.",
    },
  ],
  split: [
    {
      ...
      because: "The Split projection keeps Kaioken's pane identity, focus state, divider, and inactive-pane wash.",
    },
  ],
  settings: [
    {
      ...
      because: "The Appearance projection uses Kaioken's settings navigation hierarchy and selected-row state.",
    },
    {
      file: "apps/app/src/components/settings/settings-sections.ts",
      mustContain: ['{ icon: "Palette", id: "appearance", label: "Appearance" }'],
      because: "The settings navigation keeps Appearance as a first-class Kaioken settings destination.",
    },
    {
      ...
      mustContain: [
        ...
        'label="Palette"',
        "Palettes change kaioken's colors, including syntax colors in diffs and file previews.",
        'label="Favicon color"',
        "<SplitDimmingSetting />",
      ],
      because: "The Appearance projection keeps Kaioken's current theme, palette, favicon, and inactive-split controls.",
    },
    {
      ...
      because: "The Appearance projection keeps Kaioken's section card, responsive rows, and supporting-copy hierarchy.",
    },
  ],
