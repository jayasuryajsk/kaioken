...
Bundled and installed automatically. Select it through the environment picker or `kaioken thread spawn --environment-provider personal-workspace`. Use `kaioken environment providers --json` for its inputs and availability.
