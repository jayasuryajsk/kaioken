...
const MISSING_CLAUDE_CLI_GUIDANCE =
  "kaioken could not find the Claude Code CLI on this machine. Install Claude Code (https://claude.com/claude-code), or set KAIOKEN_CLAUDE_CODE_EXECUTABLE to the full path of the claude binary, then restart kaioken.";
