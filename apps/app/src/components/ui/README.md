...
- No product data dependencies: no queries, atoms, routing, server calls, or Kaioken
  lifecycle concepts.
- No `@kaioken/domain` types in its public API.
...
Use named feature folders for canonical rendering of Kaioken domain concepts. These
...
2. If not, is it a pure Kaioken domain renderer used by multiple consumers?
