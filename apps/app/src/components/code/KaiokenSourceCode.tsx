...
import type { KaiokenSourceCodeProps } from "./code-rendering";
...
function clearTargetLine(container: HTMLElement) {
  for (const root of getTargetRoots(container)) {
    const targetLines = root.querySelectorAll(
      "[data-kaioken-source-code-target-line]",
    );
    for (const targetLine of targetLines) {
      targetLine.removeAttribute("data-kaioken-source-code-target-line");
...
function findVirtualizedViewport(container: HTMLElement): HTMLElement | null {
  return container.querySelector<HTMLElement>("[data-kaioken-source-code-viewport]");
}
...
function KaiokenSourceCode({
  ...
  useEffect(() => {
    ...
    function scrollToLine() {
      ...
      if (line) {
        line.setAttribute("data-kaioken-source-code-target-line", "");
  ...
  return (
    <div
      ...
      data-kaioken-source-code-line-number={targetLineNumber ?? undefined}
...
export default KaiokenSourceCode;
