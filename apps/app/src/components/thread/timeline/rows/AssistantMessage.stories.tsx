...
- **Branch:** \`kaioken/investigate-file-list-inconsistency-thr_3vw9r8igrb\`
...
| Area | Change |
|---|---|
| **\`@kaioken/ui-core\` primitive (new)** | \`FilePathLink\` — clickable filename with hover-underline, optional \`external-link\` icon variant, integrates \`TruncateStart\` for path text. |
...
| **Click filename → open diff** | ❌ Dropped — needs a \`TimelineTitle\` contract change in \`@kaioken/thread-view\`. Outside scope. |
