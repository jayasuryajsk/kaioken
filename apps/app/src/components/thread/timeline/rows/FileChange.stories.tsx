...
const baseProps = {
  ...
  workspaceRootPath: "/Users/michael/.kaioken-dev/worktrees/env_story/kaioken",
};
...
const updateApiTypes: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.kaioken-dev/worktrees/env_story/kaioken/packages/server-contract/src/api-types.ts",
    kind: "update",
    movePath: null,
...
const addFormatHelpersTest: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.kaioken-dev/worktrees/env_story/kaioken/packages/thread-view/test/format-helpers.test.ts",
    kind: "add",
    movePath: null,
...
const largeRefactorComposer: TimelineRow = fileChangeRow({
  ...
  change: {
    path: "/Users/michael/.kaioken-dev/worktrees/env_story/kaioken/apps/app/src/views/ThreadFollowUpComposer.tsx",
    kind: "update",
    movePath: null,
...
const errorFileChange: TimelineRow = {
  ...
  status: "error",
  stderr:
    "ENOENT: no such file or directory, open '/Users/michael/.kaioken-dev/worktrees/env_story/kaioken/packages/server-contract/src/api-types.ts'\n",
};
