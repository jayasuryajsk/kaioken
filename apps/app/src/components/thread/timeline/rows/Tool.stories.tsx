...
const projectClaudeSkillReadTool = createSkillReadRow({
  ...
  sequenceOffset: 0,
  skillPath:
    "/Users/brsbl/Code/kaioken/.claude/skills/moss-hardening-review/SKILL.md",
});
...
const projectCodexSkillReadTool = createSkillReadRow({
  ...
  sequenceOffset: 4,
  skillPath: "/Users/brsbl/Code/kaioken/.codex/skills/workspace-tools/SKILL.md",
});
