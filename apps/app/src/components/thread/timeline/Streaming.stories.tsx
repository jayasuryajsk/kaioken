...
const PROVISIONING_LINES: readonly string[] = [
  ...
  "Preparing worktree (new branch 'kaioken/investigate-thread-timeline-load')",
  ...
  "[kaioken-env-setup] Running: pnpm exec turbo run build --filter='./packages/*'",
  "@kaioken/process-utils:build: cache hit, replaying logs",
  "@kaioken/domain:build: cache hit, replaying logs",
  "@kaioken/templates:build: cache hit, replaying logs",
  "@kaioken/secret-storage:build: cache hit, replaying logs",
  "@kaioken/hono-typed-routes:build: cache hit, replaying logs",
  "@kaioken/config:build: cache hit, replaying logs",
  "@kaioken/test-helpers:build: cache hit, replaying logs",
  "@kaioken/db:build: cache hit, replaying logs",
  "@kaioken/server-contract:build: cache hit, replaying logs",
  "@kaioken/host-daemon-contract:build: cache hit, replaying logs",
  "@kaioken/thread-view:build: cache hit, replaying logs",
  "Tasks: 12 successful, 12 total",
  "Cached: 12 cached, 12 total",
  "Time: 612ms (FULL TURBO)",
  ".kaioken-env-setup.sh finished (8.2s)",
  "Using branch: kaioken/investigate-thread-timeline-load (37eeec8)",
...
const COMMAND_OUTPUT_CHUNKS: readonly string[] = [
  "• turbo 2.8.3\n",
  "• Packages in scope: @kaioken/server, @kaioken/core-ui, @kaioken/domain, @kaioken/thread-view, @kaioken/server-contract, @kaioken/host-daemon-contract\n",
  ...
  "@kaioken/server:test:  RUN  v4.1.1 /Users/michael/.kaioken-dev/worktrees/env_33i22gvcqe/kaioken/apps/server\n",
  "@kaioken/server:test:  ✓ test/public/public-thread-interactions.test.ts (11 tests) 347ms\n",
  "@kaioken/server:test:  ✓ test/public/public-thread-data.test.ts (27 tests) 328ms\n",
  "@kaioken/server:test:  ✓ test/public/public-thread-lifecycle-regressions.test.ts (12 tests) 373ms\n",
  "@kaioken/server:test:  ✓ test/host-join-enroll.test.ts (16 tests) 451ms\n",
  "@kaioken/server:test:  ✓ test/internal/internal-command-result-idempotency.test.ts (16 tests) 451ms\n",
  "@kaioken/server:test:  ✓ test/internal/internal-event-side-effects.test.ts (16 tests) 508ms\n",
  "@kaioken/server:test:  ✓ test/services/pending-interactions.test.ts (4 tests) 595ms\n",
  "@kaioken/server:test:  ✓ test/public/public-thread-lifecycle-regressions.test.ts (12 tests) 580ms\n",
  "@kaioken/server:test:  ✓ test/services/pending-interactions.test.ts (15 tests) 510ms\n",
  "@kaioken/server:test:  ✓ test/public/public-projects-hosts.test.ts (23 tests) 654ms\n",
  "@kaioken/server:test:  ✓ test/public/public-threads.environments.test.ts (21 tests) 653ms\n",
  "@kaioken/server:test:  ✓ test/public/public-environments-system.test.ts (24 tests) 814ms\n",
  "@kaioken/server:test:  ✓ test/internal/internal-session-correctness.test.ts (33 tests) 968ms\n",
  "@kaioken/server:test:  ✓ test/public/public-thread-data.test.ts (27 tests) 979ms\n",
  "@kaioken/server:test:  ✓ test/public/public-threads.steer.test.ts (18 tests) 712ms\n",
  "@kaioken/server:test:  ✓ test/public/public-threads.send-and-steer.test.ts (24 tests) 1023ms\n",
  "@kaioken/server:test:  ✓ test/threads/timeline-service.test.ts (52 tests) 1442ms\n",
  "@kaioken/server:test:\n",
  "@kaioken/server:test:  Test Files  66 passed (66)\n",
  "@kaioken/server:test:       Tests  687 passed (687)\n",
  "@kaioken/server:test:    Start at  21:54:38\n",
  "@kaioken/server:test:    Duration  16.49s (transform 4.93s, setup 1.21s, collect 0ms, tests 14.21s)\n",
  "\n",
