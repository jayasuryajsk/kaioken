...
describe("kaioken provider command output", () => {
  setupCommandOutputTestEnvironment();

  const register: CommandRegistrar = (program) =>
    registerProviderCommands(program, () => "http://server");

  it("kaioken provider list renders the shared borderless table", async () => {
  ...
  it("kaioken provider list resolves a machine and preserves portable JSON output", async () => {
  ...
  it("kaioken provider models renders the shared borderless table", async () => {
  ...
  it("kaioken provider models includes a matching selected-only model", async () => {
    const get = vi.fn(async () => ({
      providers: [],
      models: [
        {
  ...
  it("kaioken provider models routes through an environment", async () => {
    const get = vi.fn(async () => ({
      providers: [],
      models: [],
      selectedOnlyModels: [],
