...
describe("kaioken thread interactions command output", () => {
  setupCommandOutputTestEnvironment();

  const register: CommandRegistrar = (program) =>
    registerThreadCommands(program, () => "http://server");

  it("kaioken thread interactions list renders the shared borderless table", async () => {
  ...
  it("kaioken thread interactions show prints interaction details", async () => {
    vi.stubEnv("KAIOKEN_THREAD_ID", "thread-show-interaction");
  ...
  it("kaioken thread interactions show prints a tool-use approval from its presentation", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-tool-use",
  ...
  it("kaioken thread interactions show prints user question details", async () => {
    vi.stubEnv("KAIOKEN_THREAD_ID", "thread-show-question");
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-question",
  ...
  it("kaioken thread interactions answer resolves single-question interactions with shorthand flags", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions answer resolves multi-question interactions with explicit question ids", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions answer rejects shorthand for multi-question interactions", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions answer rejects unknown explicit text question ids", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions answer rejects approvals and invalid question choices before posting", async () => {
  ...
  it("kaioken thread interactions show prints a provider's plugin-defined request with its form and data", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions respond posts the form's JSON value", async () => {
  ...
  it("kaioken thread interactions respond rejects a value that is not JSON", async () => {
    await expect(
      runCommand(
        [
          "thread",
  ...
  it("kaioken thread interactions show indicates when resolution delivery is in progress", async () => {
    vi.stubEnv("KAIOKEN_THREAD_ID", "thread-show-resolving");
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions approve resolves command approvals for the current turn", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-approve",
        providerId: "codex",
  ...
  it("kaioken thread interactions approve falls back to accept when session approval is unavailable", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions approve errors when no allow decision is available", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions deny uses decline when it is available", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-deny",
        providerId: "codex",
  ...
  it("kaioken thread interactions deny errors when deny is unavailable", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-cancel",
        providerId: "codex",
  ...
  it("kaioken thread interactions approve resolves file-change approvals without granting extra permissions", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
        id: "int-file-change",
        providerId: "codex",
  ...
  it("kaioken thread interactions grant resolves permission requests", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions grant builds a semantic turn-scoped resolution from server interaction data", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
  ...
  it("kaioken thread interactions deny resolves permission requests as denied", async () => {
    const getInteraction = vi.fn(async () =>
      fixtures.makePendingInteraction({
