...
describe("kaioken machine command output", () => {
  setupCommandOutputTestEnvironment();

  const register: CommandRegistrar = (program) =>
    registerMachineCommands(program, () => "http://server");

  it("kaioken machine list --json prints the raw host list", async () => {
  ...
  it("kaioken machine list renders names, IDs, status, and relative last seen", async () => {
  ...
  it("kaioken machine retry-update resolves the machine and requests a retry", async () => {
