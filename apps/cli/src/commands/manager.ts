...
const REMOVED_MANAGER_COMMAND_MESSAGE = [
  ...
  "Use `kaioken thread spawn --parent-thread <id>` to delegate work,",
  "`kaioken thread list --parent-thread <id>` to list child threads,",
  "and `kaioken thread show <id>` to inspect a thread.",
].join(" ");
