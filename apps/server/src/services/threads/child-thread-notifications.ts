...
import { listActiveBackgroundTaskCountsByThreadIds } from "@kaioken/db";
...
const CHILD_THREAD_OUTCOME_BATCH_UPDATES_SLOT =
  "__KAIOKEN_CHILD_THREAD_OUTCOME_BATCH_UPDATES__";
const CHILD_THREAD_MENTION_SLOT = "__KAIOKEN_CHILD_THREAD_MENTION__";
