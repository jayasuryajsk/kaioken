...
state directory. Read `scripts/kaioken-cloud-dev.mjs` first: it derives gateway,
...
- The local launcher enables disposable email/password account creation from Create an account. This exercises dashboard authentication without GitHub OAuth setup. Keep OAuth/email-provider integration as separate prerequisite-gated checks. Source: `scripts/kaioken-cloud-dev.mjs:245`.
