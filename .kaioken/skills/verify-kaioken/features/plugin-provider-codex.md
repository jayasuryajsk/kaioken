...
| Session controls | Fork, compact, edit at a checkpoint, rename/archive, stop/retry, and resume synthetic sessions. | Provider/session and Kaioken thread state stay consistent; unsupported operations fail explicitly. |
