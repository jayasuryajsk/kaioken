...
Settings → Plugins → Custom instructions; kaioken plugin run custom-instructions --help and the plugin command schema.
...
- Use kaioken instructions get|set|clear, or explicit kaioken plugin run custom-instructions get|set|clear. Settings route is /settings/plugins/custom-instructions. Source: `plugins/custom-instructions/server.ts:73`.
