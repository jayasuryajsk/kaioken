...
- Cloud preflight also requires its checkout-derived gateway/worker/web ports to be free and `.wrangler/cloud-dev` absent or owned. Preserve local R2/D1 fixtures outside the checkout after stopping only the owned invocation. Source: `scripts/kaioken-cloud-dev.mjs:163`.
