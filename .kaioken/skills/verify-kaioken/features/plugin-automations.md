...
Open Extensions/Automations or the Automations plugin panel; kaioken automation --help. Use a disposable project and short synthetic commands.
...
- New automation and normal Edit with chat seed a thread composer. Use the chat workflow or kaioken automation create/update for name/script/schedule/execution changes; do not require a general name/script/schedule form that this revision does not expose. Source: `plugins/automations/app.tsx:416; plugins/automations/app.tsx:464`.
