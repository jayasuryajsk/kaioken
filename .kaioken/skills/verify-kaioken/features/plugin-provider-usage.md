...
| CLI and SDK parity | Compare kaioken settings usage --json with bb.sdk.system.usageLimits() and the visible card. | All surfaces represent the same underlying provider maintenance data. |
