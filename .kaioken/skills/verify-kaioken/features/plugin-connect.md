...
Settings → Remote access; use `kaioken connect` for command help. Use the local cloud stack and a fresh synthetic store/account. Never pair an imported store or use the owner’s live tunnel as a fixture.
