...
| Compaction and clear context | On idle/failed threads call compact and clear separately; follow up afterward. | Provider reports completion or unsupported action; Kaioken does not invent a successful compaction. |
