...
Settings → Accounts; kaioken pool --help. Use disposable provider accounts, an isolated credential store, and synthetic threads. Never print imported credentials.
