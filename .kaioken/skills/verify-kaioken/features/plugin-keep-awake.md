...
Settings → Plugins → Keep awake; kaioken keep-awake --help. A disposable macOS host is required for an actual power assertion; Linux can verify unsupported-host reporting.
