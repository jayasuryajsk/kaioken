...
GitHub panel; kaioken github --help. Use cached synthetic/read-only fixtures first; live writes need an authorized disposable GitHub repository and authenticated gh.
