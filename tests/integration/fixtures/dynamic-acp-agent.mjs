...
if (listMode) {
  console.log("kaioken-dynamic-smoke-medium - Dynamic Smoke Medium");
  console.log("kaioken-dynamic-smoke-high - Dynamic Smoke High");
  process.exit(0);
}
...
const acpModels = [
  {
    value: "kaioken-dynamic-acp-native-default",
    name: "Dynamic ACP Native Default",
  },
  { value: "kaioken-dynamic-acp-native-strong", name: "Dynamic ACP Native Strong" },
];
