import {
  workspaceTransferCommandSchemas,
...
import {
  sshConnectionCommandSchemas,
  sshConnectionListSchema,
  sshConnectionSchema,
  sshHttpResponseSchema,
...
export const hostDaemonCommandRegistry = {
  ...
  "host.ssh.list": defineHostDaemonCommandDescriptor({
    type: "host.ssh.list",
    schema: sshConnectionCommandSchemas["host.ssh.list"],
    resultSchema: sshConnectionListSchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "host.ssh.request": defineHostDaemonCommandDescriptor({
    type: "host.ssh.request",
    schema: sshConnectionCommandSchemas["host.ssh.request"],
    resultSchema: sshHttpResponseSchema,
    transport: "onlineRpc",
    retryable: false,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "host.ssh.connect": defineHostDaemonCommandDescriptor({
    type: "host.ssh.connect",
    schema: sshConnectionCommandSchemas["host.ssh.connect"],
    resultSchema: sshConnectionSchema,
    transport: "onlineRpc",
    retryable: false,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "host.ssh.disconnect": defineHostDaemonCommandDescriptor({
    type: "host.ssh.disconnect",
    schema: sshConnectionCommandSchemas["host.ssh.disconnect"],
  ...
  "workspace.transfer.inspect": defineHostDaemonCommandDescriptor({
    type: "workspace.transfer.inspect",
    schema: workspaceTransferCommandSchemas["workspace.transfer.inspect"],
    resultSchema: gitTransferRepositorySchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "workspace.transfer.export": defineHostDaemonCommandDescriptor({
    type: "workspace.transfer.export",
    schema: workspaceTransferCommandSchemas["workspace.transfer.export"],
    resultSchema: workspaceTransferManifestSchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "workspace.transfer.read": defineHostDaemonCommandDescriptor({
    type: "workspace.transfer.read",
    schema: workspaceTransferCommandSchemas["workspace.transfer.read"],
    resultSchema: workspaceTransferChunkSchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "workspace.transfer.write": defineHostDaemonCommandDescriptor({
    type: "workspace.transfer.write",
    schema: workspaceTransferCommandSchemas["workspace.transfer.write"],
    resultSchema: workspaceTransferWriteResultSchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
  }),
  "workspace.transfer.restore": defineHostDaemonCommandDescriptor({
    type: "workspace.transfer.restore",
    schema: workspaceTransferCommandSchemas["workspace.transfer.restore"],
    resultSchema: workspaceTransferRestoredSchema,
    transport: "onlineRpc",
    retryable: true,
    flushEventsBeforeResult: false,
    envLane: null,
