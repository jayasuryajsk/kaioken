...
const hostDaemonOnlineRpcResponseSuccessSchema = z.discriminatedUnion(
  ...
  [
    ...
    onlineRpcResponseSuccessSchemaFor("host.ssh.list"),
    onlineRpcResponseSuccessSchemaFor("host.ssh.connect"),
    onlineRpcResponseSuccessSchemaFor("host.ssh.disconnect"),
    onlineRpcResponseSuccessSchemaFor("host.ssh.request"),
    onlineRpcResponseSuccessSchemaFor("workspace.transfer.inspect"),
    onlineRpcResponseSuccessSchemaFor("workspace.transfer.export"),
    onlineRpcResponseSuccessSchemaFor("workspace.transfer.read"),
    onlineRpcResponseSuccessSchemaFor("workspace.transfer.write"),
    onlineRpcResponseSuccessSchemaFor("workspace.transfer.restore"),
    onlineRpcResponseSuccessSchemaFor("codex.rollouts.locate"),
    onlineRpcResponseSuccessSchemaFor("codex.rollouts.copy"),
    onlineRpcResponseSuccessSchemaFor("codex.rollouts.read"),
