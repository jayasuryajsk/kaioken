/**
 * `@get-kaioken/plugin-sdk/testing` — the backend plugin test harness: a fake Kaioken
 * plugin host (`createFakePluginHost`) whose `kaioken` satisfies `KaiokenPluginApi`,
 ...
 * `@get-kaioken/plugin-sdk/testing/app` so backend-only tests never load React.
 */
export {
