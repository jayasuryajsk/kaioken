---
kind: instruction
title: kaioken Guide Automations
...
in a thread; script automations run stored code without model usage.
  ...
  kaioken automation create --project <id> --name <name> <schedule> <execution>
  kaioken automation update <automationId> --project <id> [changes]
  kaioken automation pause|resume <automationId> --project <id>
  kaioken automation run <automationId> --project <id>
  kaioken automation runs <automationId> --project <id> [--limit <count>]
...
available through the CLI:
  ...
  kaioken automation update <automationId> --project <id> --prompt "<prompt>"
