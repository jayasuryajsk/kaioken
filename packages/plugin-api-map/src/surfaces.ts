...
export const SURFACE_GROUPS: SurfaceGroup[] = [
  {
    id: "app-shell",
    title: "The kaioken app window",
    fixtureKind: "spatial",
    blurb:
      "The main kaioken window, containing the sidebar, the conversation, and the side panel. A plugin can add rows, controls, panel tabs, and message content to the numbered regions.",
    surfaces: [
      {
        id: "sidebar-navigation",
        title: "Sidebar navigation",
        summary:
          "Replaces kaioken's navigation controls above the thread list with a component your plugin renders. With this, a plugin can:",
        bullets: [
          "Arrange New thread, Search, Plugins, Skills, and plugin destinations",
          "Activate each destination through kaioken, including split placement for supported items",
          "Render kaioken's original controls when the plugin wants to delegate",
          "Leave the thread list, footer, drawer, and resize handle under kaioken's control",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Adds a row to kaioken's sidebar that opens a page your plugin renders where threads normally appear. With this, a plugin can:",
        bullets: [
          "Render any React you write across that whole area",
          "Get its own URL, so the page can be linked to and kaioken's back and forward buttons work",
          "Register tabs in the panel to the right of its page, beside kaioken's own Browser and Terminal tabs",
        ],
      ...
      },
      {
        ...
        summary:
          "A small status kaioken can draw on a thread's row in the sidebar. With this, a plugin can:",
        bullets: [
          "Give the status an icon and a label",
          "Mark a thread as running while it works on it, and kaioken shimmers the icon",
          "Mark it succeeded or failed when the work ends, and kaioken settles the icon",
          ...
          "Rely on kaioken to clear it when the script unmounts",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Replaces the list of threads in kaioken's sidebar with a component your plugin renders. With this, a plugin can:",
        bullets: [
          "Render every row, and decide the grouping, the ordering, and what each row shows",
          "Read the same live thread data and run statuses kaioken's own list reads",
          "Replace only the list. The New thread button, the search action, the plugin rows, and the sidebar footer stay kaioken's",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Adds a host-rendered icon item to the bottom of kaioken's sidebar. With this, a plugin can:",
        bullets: [
          "Run an action, or reveal plugin-rendered content above the footer row",
          "Let kaioken coordinate one open disclosure across every enabled plugin",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Render in the same row as kaioken's own header controls",
        ],
      ...
      },
      {
        ...
        summary:
          "Renders the expanded content of plugin-owned timeline entries while kaioken keeps each entry's header and controls. With this, a plugin can:",
        bullets: [
          "Draw the expanded content beneath timeline entries created by the plugin's own provider",
          "Receive the entry data and plugin payload, plus kaioken's default content as `Original`",
          "Fall back to kaioken's default content automatically when the plugin is unavailable or crashes",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Replaces kaioken's source-code or diff renderer everywhere that kind of content appears. With this, a plugin can:",
        bullets: [
          "Register the source-code and diff replacements independently",
          "Apply each replacement across kaioken's file previews, timeline and environment diffs, and plugin pages",
          "Hand any individual render back to kaioken's built-in renderer, and fall back to it automatically if the plugin is unavailable or crashes",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        summary:
          "Registers a viewer for the file types you name, so kaioken opens those files there instead of its built-in preview. With this, a plugin can:",
        bullets: [
          "Declare the file extensions it handles, for example `.csv` or `.excalidraw`",
          "Render its own viewer or editor whenever a file of that type is opened in kaioken",
      ...
      },
      {
        ...
        summary:
          "Mounts floating plugin UI across the kaioken app, outside route-owned layout regions. With this, a plugin can:",
        bullets: [
          "Render a persistent widget once per kaioken window while the plugin is enabled",
      ...
      },
      {
        ...
        summary:
          "Runs your code inside the kaioken window itself, without rendering a UI of its own. With this, a plugin can:",
        bullets: [
          "Mount once per kaioken window and unmount when the window reloads",
          ...
          "Add plugin-owned elements to app pages without taking ownership of kaioken's built-in layout",
          "Return a cleanup function. kaioken calls it once on unmount, and clears any row statuses the script set",
        ],
        apiSymbols: [
  ...
  },
  {
    ...
    fixtureKind: "spatial",
    blurb:
      "kaioken's searchable command menu. A plugin can add actions that match, rank, and run alongside kaioken's own commands.",
    surfaces: [
      {
        id: "command-palette-actions",
        title: "Command palette actions",
        summary:
          "Adds a row under Plugins in kaioken's quick command palette. With this, a plugin can:",
        bullets: [
          "Supply the row's label and run behavior; kaioken owns matching, ordering, and recency",
  ...
  },
  {
    ...
    surfaces: [
      ...
      },
      {
        ...
        title: "Mentions",
        summary:
          "Adds results to the menu that opens when someone types a trigger character in the prompt box. On a trigger kaioken does not use itself, your plugin opens that menu and owns it. With this, a plugin can:",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          "Supply each row's icon, label, and disabled state; kaioken renders the row itself",
      ...
      },
      {
        ...
        summary:
          "Adds an agent to kaioken's model picker and runs the threads started with it. With this, a plugin can:",
        bullets: [
          "Appear in the model picker beside kaioken's built-in providers",
          ...
          "Add models to another provider's picker and route the threads that pick them",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Render in the same row as kaioken's own prompt-box buttons. If you have more than 3 plugins enabled, kaioken keeps the 3 most-used plugins inline and moves the rest into an overflow menu",
        ],
  ...
  },
  {
    ...
    fixtureKind: "spatial",
    blurb:
      "The screen kaioken opens on, holding the new-thread composer and a side panel. A plugin can add a section below the composer, and an action in that panel that opens its own tab.",
    surfaces: [
      {
        id: "homepage-section",
        title: "Home-screen sections",
        summary:
          "Adds a full-width section to the page kaioken opens on, below the prompt box. With this, a plugin can:",
        bullets: [
          ...
          "Render after kaioken's own content, in the order plugins registered",
        ],
  ...
  },
  {
    ...
    fixtureKind: "spatial",
    blurb:
      "The settings page kaioken creates for every installed plugin. A plugin can declare fields for kaioken to render and add its own section below them.",
    surfaces: [
      {
        id: "declarative-settings",
        title: "Settings fields",
        summary:
          "Declares the settings your plugin needs as plain data; kaioken renders the form for them on the plugin's settings page and stores the values. With this, a plugin can:",
        bullets: [
          ...
          "Mark a text field secret: kaioken stores it in a protected file on the server and never sends it to the browser",
      ...
      },
      {
        ...
        summary:
          "Renders your own React component on the plugin's settings page, below the [fields kaioken generated](declarative-settings). Use it for anything that is not a value in a form. With this, a plugin can:",
        bullets: [
          ...
          "Supply a heading and a one-line description for kaioken to render above it",
        ],
  ...
  },
  {
    ...
    fixtureKind: "spatial",
    blurb:
      "The page kaioken shows for an installed plugin under Plugins: what it is, what it registers, and whether it is healthy. A plugin can report that it needs configuring, and kaioken says so at the top of this page.",
    surfaces: [
      {
        id: "plugin-status",
        title: "Configuration status",
        summary:
          "Reports that the plugin cannot run until someone configures it, so kaioken can say so instead of the plugin failing silently. With this, a plugin can:",
        bullets: [
  ...
  },
  {
    ...
    surfaces: [
      {
        id: "cli",
        tagline: "Your own `kaioken <name>` command",
        title: "kaioken CLI commands",
        summary:
          "Registers a top-level `kaioken <name>` command, available in the terminal and to agents. With this, a plugin can:",
        bullets: [
          "Be invoked the same way by a person at a terminal and by an agent mid-task",
          "Receive the thread and project it was invoked from, when kaioken knows them",
      ...
      },
      {
        ...
        summary:
          "Adds tools, skills, and instructions to the agent sessions kaioken runs. With this, a plugin can:",
        bullets: [
          "Register tools an agent calls the same way it calls kaioken's built-in tools",
      ...
      },
      {
        ...
        summary:
          "Runs code on the kaioken server when no window is open. With this, a plugin can:",
        bullets: [
          "Register long-running services that kaioken starts, supervises, and restarts after a failure",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Push messages to every open kaioken window, so the UI does not have to poll",
        ],
        apiSymbols: [
          "PluginRpc",
          "PluginHttp",
      ...
      },
      {
        ...
        bullets: [
          "Declare a provider with a display name and icon, picked in New Thread or kaioken thread spawn --environment-provider",
          ...
          "Declare what it needs from the request as a zod inputs schema; kaioken parses the request with it before the thread exists, publishes it as JSON Schema for the CLI, and hands create the parsed value as inputs",
          ...
          "Let kaioken run the repo setup hook after an owned-path create and teardown before removal; attached paths skip both hooks; unknown hook outcomes after daemon restart block automatic cleanup",
          ...
          "Name a branch the way kaioken would, from the suggestedBranchName core hands every create, and stream progress with report.step and report.log",
      ...
      },
      {
        ...
        title: "Host workers",
        summary:
          "Runs the plugin's code on an enrolled machine, not only on the kaioken server. With this, a plugin can:",
        bullets: [
          "Ship a Node entry point kaioken starts on demand on the machine it calls",
          ...
          "Declare desired loopback ports once and let kaioken deliver retained declarations when an enrolled machine reconnects",
      ...
      },
      {
        ...
        title: "Storage",
        summary:
          "Stores the plugin's data on the kaioken server. With this, a plugin can:",
        bullets: [
      ...
      },
      {
        ...
        title: "The kaioken SDK",
        summary:
          "Calls kaioken's own API from the plugin's server code. With this, a plugin can:",
        bullets: [
          "Create threads, send messages to them, and manage projects",
          "List enrolled machines",
          "Reach the same operations the [kaioken CLI](cli) and the kaioken UI use",
        ...
        apiSymbols: ["KaiokenPluginApi", "PluginServerApi"],
        firstParty: [
          "Automations",
          "Docs",
          "GitHub",
      ...
      },
      {
        ...
        bullets: [
          ...
          "List browsers installed on the desktop host and copy a profile's signed-in cookies into the personal Kaioken browser or an automation profile",
        ],
        apiSymbols: [
      ...
      },
      {
        ...
        tagline: "Discover Kaioken computers and manage SSH connections",
        summary:
          "Use bb.sdk.experimental_connections to inspect the owning server and connect through the controller computer's OpenSSH configuration. With this, a plugin can:",
        bullets: [
          "Read the stable server UUID, primary host ID and connected-workspace protocol with self",
          "List Kaioken installations discovered through the paired Connect account",
          "Discover concrete SSH aliases and inspect connection state with ssh.list",
          "Start or attach to an installed remote Kaioken runtime with ssh.connect({ alias, remotePort })",
          "Close and forget a tunnel with ssh.disconnect({ alias }); tasks continue on the remote computer",
          "Resolve a saved computer handle to its current installation identity with resolve({ handle }); null means this server",
          "Preview matching destination projects and move a native Codex task with handoffs.preview and handoffs.start; use a stable operation UUID",
          "Read durable transfer progress with handoffs.get, or recover with handoffs.retry and handoffs.cancel",
        ],
        apiSymbols: [
      ...
      {
        id: "ai-services",
        tagline: "Serve kaioken's helper model from your own machine",
        title: "AI services",
        summary:
          "Lets a plugin answer kaioken's own helper-model calls — the short model calls behind thread titles and commit messages, and the microphone button's transcription. With this, a plugin can:",
        bullets: [
          "Serve those calls from an enrolled machine, so kaioken's helper model can be one the plugin holds the credentials for",
          "Serve voice transcription the same way, for the microphone button in the prompt box",
          "Appear as a choice in the AI-service settings, alongside the models kaioken reaches itself",
        ],
      ...
      {
        id: "host-components",
        tagline: "Embed kaioken's chat and prompt box",
        title: "Host components",
        summary:
          "Renders kaioken's own conversation and prompt-box components inside the plugin's pages. With this, a plugin can:",
        bullets: [
          "Embed the thread view and the new-thread prompt box as components",
          "Render message text with the same Markdown renderer kaioken uses",
          "Inherit kaioken's styling, so embedded UI matches the rest of the app",
        ],
        apiSymbols: [
          "ThreadChat",
          "Markdown",
      ...
      {
        id: "testing",
        tagline: "Unit-test every surface without a running kaioken",
        title: "Testing harnesses",
        summary:
          "Tests the plugin without a running kaioken. With this, a plugin can:",
        bullets: [
          "Run its server code against an in-process fake of the kaioken server",
