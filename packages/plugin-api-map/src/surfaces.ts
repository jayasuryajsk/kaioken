    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Request suspend/resume through the host SDK; calls return the updated host when the tracked operation starts, core coordinates drain, project checkout setup rejects suspend with machine_busy, and plugins own idle policy",
