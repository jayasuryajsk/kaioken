    ...
    surfaces: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Use experimental_BranchPicker for a standard branch choice, or compose experimental_useBranches with experimental_useCheckoutState when it needs checkout-aware branch selection; with no host yet, experimental_useBranches uses the project source for suggestions",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Prepare single-use enrollment bundles with enrollments.prepare and enrollments.waitForConnection; keys retain the host identity reserved on the launch",
        ...
        apiSymbols: [
          ...
          "HostsArea.experimental_submit",
          "HostsArea.experimental_launch",
          "HostsArea.experimental_follow",
          "HostsArea.experimental_cancel",
