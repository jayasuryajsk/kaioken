  ...
  it("appends sanitized skill instructions after the base instructions", () => {
    expect(
        ...
        skillRoots: [
          {
            ...
            skillDirectoryRootPath:
              "/tmp/kaioken/runtime/global-skills/abc123/skills",
            skills: [
              {
                name: "release-notes",
                description:
      ...
      instructions: [
        ...
        "- release-notes: Use release-notes when /system_instructions tests run. (SKILL.md: /tmp/kaioken/runtime/global-skills/abc123/skills/release-notes/SKILL.md)",
        "- copywriting: Use when writing customer copy. (SKILL.md: /tmp/kaioken/runtime/global-skills/abc123/skills/copywriting/SKILL.md)",
      ].join("\n"),
    });
  });
  ...
  it("starts with the skill block when the session has no base instructions", () => {
    expect(
        ...
        skillRoots: [
          {
            ...
            skillDirectoryRootPath:
              "/tmp/kaioken/runtime/global-skills/def456/skills",
            skills: [
              {
                name: "debugging",
      ...
      instructions: [
        ...
        "",
        "Available kaioken skills:",
        "- debugging: Use when debugging runtime state. (SKILL.md: /tmp/kaioken/runtime/global-skills/def456/skills/debugging/SKILL.md)",
      ].join("\n"),
    });
  });
